...
class CloserRegisterPage extends ConsumerStatefulWidget {
  const CloserRegisterPage({super.key});

  @override
  ConsumerState<CloserRegisterPage> createState() => _CloserRegisterPageState();
}

class _CloserRegisterPageState extends ConsumerState<CloserRegisterPage> {
        ...
        body: ListView(
          children: [
            ...
            Form(
              ...
              child: AppFieldsColumn(
                ...
                children: [
                  ...
                  const Text(
                    "Register as a new member of closer.",
                    style: TextStyle(
                  ...
                  const Text(
                      'Every request must be examined before approval. Book an exam date to be manually check by employee.'),
                  const AppCheckbox(
            ...
            AppTextButton(
              ...
              text: "I already have a closer account",
